...
***********************************************
global country_selection "ARG"  
* Options: "PER" (Peru) or "ARG" (Argentina)
***********************************************
...
if "$country_selection" == "PER" {
    ...
    * Define all 1-year consecutive panels (no long panel)
    ...
    noi di as error "ERROR: Invalid country_selection. Must be 'PER' or 'ARG'"
...
if "$country_selection" == "PER" {
    ...
    * Argentina only has 2-digit ISCO
    gen isco_4d = .
    label var isco_4d "ISCO-08 occupation code, 4-digit (not available for Argentina)"
    
    gen isco_3d = .
    label var isco_3d "ISCO-08 occupation code, 3-digit (not available for Argentina)"
...
* Country-specific handling of sector classification
if "$country_selection" == "PER" {
    * Peru: Derive ISIC 1-digit from 4-digit sector_orig
    gen isic_1d = .
